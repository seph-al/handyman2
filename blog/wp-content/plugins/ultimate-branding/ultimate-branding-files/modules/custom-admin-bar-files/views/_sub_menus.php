...
<?php $i = 1; foreach( $menu->subs as $sub): ?>
    <div class="postbox closed ub_admin_bar_submenu">
        ...
        <h3 class="hndle">
            <a href="#" data-id="<?php echo $sub->id; ?>" class="wdcab_step_delete button-secondary pull-right ub_delete_row"><?php _e("Delete", "ub"); ?></a>
                                                <span>
        ...
        <div class="inside">
            ...
            <p>
                ...
                <input type="text" id="<?php echo $menu->get_field_id( "ub_admin_bar_url" ); ?>" class="wdcab_step_url widefat" name="ub_ab_prev[<?php echo $menu->id ?>][links][<?php echo $sub->id ?>][url]" value="<?php echo $sub->link_url; ?>">
            </p>
            ...
            <p>
                <input id="<?php echo $menu->get_field_id( "ub_admin_bar_target" ); ?>" type="checkbox" class="wdcab_step_target" name="ub_ab_prev[<?php echo $menu->id ?>][links][<?php echo $sub->id ?>][target]" <?php  checked( $sub->link_target, "_blank" ); ?>>
                <label for="<?php echo $menu->get_field_id( "ub_admin_bar_target" ); ?>"><?php _e("Open in new window", "ub") ?></label><br>
            </p>
        </div>
    </div>
<?php $i++; endforeach; ?>