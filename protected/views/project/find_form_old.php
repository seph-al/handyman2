			...
			<div class="row-fluid">
				<div class="findJobLeft col-md-8 clearfix">
					<div class="contMatched">
						<span class="contain contMatchedTxt1">There is no Projects Matched</span>
				...
				<div class="findJobRight col-md-4" style="height:auto;">
					<div class="contain margin1Btm">
						<ul class="findRiteUlNew">
							...
							<?php if (count($projects)>0):?>
							   <?php foreach($projects as $k=>$v):?>
							     <li><a  href="<?php echo Yii::app()->request->baseUrl; ?>/project/find/project/<?php echo $v->ProjectTypeId?>/n/<?php echo Ini::slugstring($v->Name)?>"><?php echo $v->Name?></a></li>
							   <?php endforeach;?>
							<?php endif;?>
                        </ul>
