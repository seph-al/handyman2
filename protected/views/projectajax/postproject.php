<table width="730" cellspacing="0" cellpadding="0" border="0" align="" style="border:50px solid #79BAEC;font:normal 14px/15px Verdana">
	...
	<tbody style="display:block;font:normal 13px/17px Verdana;margin-top:15px">
		<tr style="display:block;margin-bottom:10px;color:#f89b2e;font:normal 16px/17px Verdana;padding:0 25px">
			<td align="left" style="font-weight:bold" colspan="3">Hi <?php echo $proj->homeowner->firstname?>,</td>
		</tr>
		<tr style="display:block;margin-bottom:10px;padding:0 25px">
			<td align="left" style="font:bold 16px/17px Verdana" colspan="3">
			  Your Project Was Posted Successfully. See The Posted Project Details Below:
			</td>
		</tr>
		<tr style="display:block;margin:20px 0 10px;padding:0 25px">
			<td width="25%" valign="top" align="left" style="display:inline-block;font-weight:bold">Project ID: </td>
			<td width="5%" valign="top" align="center" style="display:inline-block;font-weight:bold">:</td>
			<td width="60%" valign="top" align="left" style="display:inline-block"><?php echo $proj->project_id?>
			</td>
		</tr>
		<tr style="display:block;margin:20px 0 10px;padding:0 25px">
			<td width="25%" valign="top" align="left" style="display:inline-block;font-weight:bold">Project Description</td>
			<td width="5%" valign="top" align="center" style="display:inline-block;font-weight:bold">:</td>
			<td width="60%" valign="top" align="left" style="display:inline-block"><?php echo $proj->description?></td>
		</tr>
