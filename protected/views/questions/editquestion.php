																...
																<div class="qa-sidepanel">
																  ...
																  <div class="col-md-7qa">
																		...
																		<div class="qa-main">
																			...
																			<form role="form" action="javascript:processEdit();" method="post" id="question-post-form">
																			<div class="form-group">
																				<label for="">The question in one sentence:</label>
																				<input type="text" name="q_title" id="q_title" class="form-control"  value="<?php echo $question->title?>">
																			  </div>
																			  <div class="form-group">
																				...
																				<select class="form-control" name="q_category" id="q_category">
																				  ...
																				  <?php if (count($projects)>0):?>
																				      <?php foreach($projects as $k=>$v):?>
																				          <option value="<?php echo $v->ProjectTypeId?>" <?php if ($question->project_type_id == $v->ProjectTypeId) echo "selected"?>><?php echo $v->Name?></option>
																				      <?php endforeach;?>
																				  <?php endif?>
																				</select>
																			  </div>
																			  <div class="form-group">
																				...
																				<textarea class="form-control" rows="3" id="q_content" name="q_content"><?php echo $question->content?></textarea>
																			  </div>
																			  
																			  <input type="hidden" name="t" value="updatequestion" id="t">
																			  <input type="hidden" name="question_id" value="<?php echo $question->question_id?>"  id="question_id">
