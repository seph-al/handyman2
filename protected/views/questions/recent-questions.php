					...
					<div id="q1523" class="qa-q-list-item">
						<div class="qa-q-item-stats">
							<div id="voting_<?echo $v->question_id?>" class="qa-voting qa-voting-net">
								  <form id="vote_form-<?echo $v->question_id?>" action="javascript:processVote(<?echo $v->question_id?>)">
					   ...
					   <span class="qa-q-item-avatar-meta">
							 ...
							 <?if(!Yii::app()->user->isGuest && $v->owner_user_type == Yii::app()->user->role && $v->owner_id = Yii::app()->user->getId()):?>
								  <div class="bread">
