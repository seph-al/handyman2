...
class Urls extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('RewriteTo, IncomingUrl, Created', 'required'),
			array('IsDeleted', 'numerical', 'integerOnly'=>true),
			array('RewriteTo, IncomingUrl', 'length', 'max'=>100),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('UrlId, RewriteTo, IncomingUrl, IsDeleted, Created', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('RewriteTo',$this->RewriteTo,true);
