...
<script type="text/javascript" src="<?php echo Yii::app()->request->baseUrl; ?>/js/auth/index.js"></script>
<script type="text/javascript">
$(document).ready(function(){
	gAuth = Object.create(Handyman.Auth);
	gAuth.init('auth');
	gAuth.redirectUrl = decodeURIComponent('<?php echo isset($_GET['redirect'])?($_GET['redirect']):'';?>');
	gAuth.baseUrl = $('#base_url').val();	
});
</script>