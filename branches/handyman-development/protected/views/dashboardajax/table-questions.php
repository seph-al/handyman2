 ...
 <div class="qa-q-list" id="question-row-<?echo $v->question_id?>">
    	...
    	<div class="qa-q-item-stats">
			<div id="voting_1523" class="qa-voting qa-voting-net">
                  <div class="qa-vote-buttons qa-vote-buttons-net">
                        <input class="qa-vote-first-button qa-vote-up-button" type="submit" disabled> 
       ...
       <span class="qa-q-item-avatar-meta">
               <span class="qa-q-item-meta">
                 <a class="qa-q-item-what" href="<?php echo Yii::app()->request->baseUrl; ?>/questions/details/id/<?php echo $v->question_id?>/n/<?php echo Yii::app()->Ini->slugstring($v->title)?>">answered</a>
					...
					<!-- 
					<span class="qa-q-item-who-points"><span class="qa-q-item-who-points-pad">
																								  (
																								</span><span class="qa-q-item-who-points-data">
																								  140
																								</span><span class="qa-q-item-who-points-pad">
																								   points)
																								</span>
                      </span>
						 -->																	
   ...
   <div class="alert alert-warning fade in">
      ...
      <strong>You don't have any questions posted!</strong>
    </div>
<?php endif;?>