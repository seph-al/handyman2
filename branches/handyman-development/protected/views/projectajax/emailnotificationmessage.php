<table width="730" cellspacing="0" cellpadding="0" border="0" align="" style="border:50px solid #79BAEC;font:normal 14px/15px Verdana">
	...
	<tbody style="display:block;font:normal 13px/17px Verdana;margin-top:15px">
		<tr style="display:block;margin-bottom:10px;color:#f89b2e;font:normal 16px/17px Verdana;padding:0 25px">
			<td align="left" style="font-weight:bold" colspan="3">Hi <?php echo $name?>,</td>
		</tr>
		<tr style="display:block;margin-bottom:10px;padding:0 25px">
			<td align="left" style="font:bold 16px/17px Verdana" colspan="3"><?php echo $sender_name?> send you a message</td>
		</tr>
		
		<tr style="display:block;margin:20px 0 10px;padding:0 25px">
			<td width="25%" valign="top" align="left" style="display:inline-block;font-weight:bold">Project Details</td>
			<td width="5%" valign="top" align="center" style="display:inline-block;font-weight:bold">:</td>
			<td width="60%" valign="top" align="left" style="display:inline-block"><?php echo $details?>
			</td>
		</tr>
		
		<tr style="display:block;margin:20px 0 10px;padding:0 25px">
			<td width="25%" valign="top" align="left" style="display:inline-block;font-weight:bold">Subject</td>
			<td width="5%" valign="top" align="center" style="display:inline-block;font-weight:bold">:</td>
			<td width="60%" valign="top" align="left" style="display:inline-block"><?php echo $subject?>
			</td>
		</tr>
		<tr style="display:block;margin:20px 0 10px;padding:0 25px">
			<td width="25%" valign="top" align="left" style="display:inline-block;font-weight:bold">Message</td>
			<td width="5%" valign="top" align="center" style="display:inline-block;font-weight:bold">:</td>
			<td width="60%" valign="top" align="left" style="display:inline-block"><?php echo $message?></td>
		</tr>
				...
				<table style="display:block;font-weight:bold;font-size:13px">
					<tbody>
						...
						<tr style="display:block;padding:0 25px;margin-top:15px">
							<td valign="top" align="left" colspan="3"><a target="_blank" href="" style="text-decoration:none;color:#1576ac">http://www.handymen.com</a>
							</td>
						</tr>
					</tbody>
				</table>
