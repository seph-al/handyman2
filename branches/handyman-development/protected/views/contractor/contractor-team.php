												  ...
												  <div class="panel-body">
													<div class="media">
														  <a class="pull-left" href="#">
														   <?php 
														     $pic= Contractorphotos::model()->findByAttributes(array('contractor_id'=>$v->invite->ContractorId,'is_profile'=>1));
														     if (count($pic)>0){
														  ...
														  <div class="media-body">
															<h4 class="media-heading"><a href=""><?echo $v->invite->Name?></a></h4>
															<span class="desc1">Services:</span>
															<span class="desc2"><?echo substr($v->invite->Services,0,35)?>..<a href="<?php echo Yii::app()->request->baseUrl; ?>/contractor/profile/user/<?echo $v->invite->Username?>">Read More</a></span>
														  </div>
