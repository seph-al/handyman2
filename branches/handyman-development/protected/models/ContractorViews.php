...
/**
 * This is the model class for table "contractor_views".
 *
 * The followings are the available columns in table 'contractor_views':
 ...
 */
class ContractorViews extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return ContractorViews the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
			...
			array('contractor_id, viewed_by', 'numerical', 'integerOnly'=>true),
			array('viewed_user_type', 'length', 'max'=>100),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('view_id, contractor_id, viewed_by, viewed_user_type, date_viewed', 'safe', 'on'=>'search'),
		);
	}
